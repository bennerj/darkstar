...
HARVESTING_BREAK_CHANCE = 0.15; -- % chance for the sickle to break during harvesting.  Set between 0 and 1.
EXCAVATION_BREAK_CHANCE = 0.15; -- % chance for the pickaxe to break during excavation.  Set between 0 and 1.
LOGGING_BREAK_CHANCE    = 0.15; -- % chance for the hatchet to break during logging.  Set between 0 and 1.
